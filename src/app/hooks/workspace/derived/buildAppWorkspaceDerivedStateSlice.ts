...
export function buildAppWorkspaceDerivedStateSlice(state: AppWorkspaceState) {
  return {
    ...
    dismissNotificationHistoryItem: state.dismissNotificationHistoryItem,
    milestoneReportDraft: state.milestoneReportDraft,
    milestoneReportFindings: state.milestoneReportFindings,
    milestoneReportModalMode: state.milestoneReportModalMode,
    isDarkMode: state.isDarkMode,
    isEmailAuthAvailable: state.isEmailAuthAvailable,
    isGoogleAuthAvailable: state.isGoogleAuthAvailable,
    isLoadingData: state.isLoadingData,
    isNotificationQueueOpen: state.isNotificationQueueOpen,
    isUnmatchedMyViewActive: state.isUnmatchedMyViewActive,
    ...
    setMilestoneReportDraft: state.setMilestoneReportDraft,
    setMilestoneReportFindings: state.setMilestoneReportFindings,
    setMilestoneReportModalMode: state.setMilestoneReportModalMode,
    setInventoryView: state.setInventoryView,
    setIsUnmatchedMyViewActive: state.setIsUnmatchedMyViewActive,
    ...
    dismissTaskEditNotice: state.dismissTaskEditNotice,
