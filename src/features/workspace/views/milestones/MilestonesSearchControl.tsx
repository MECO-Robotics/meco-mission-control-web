...
const MILESTONE_SEARCH_COMPACT_SWITCH_WIDTH = 360 + MILESTONE_SEARCH_ACTION_OVERLAY_WIDTH;
const MILESTONE_SEARCH_ICON_SWITCH_WIDTH = 260 + MILESTONE_SEARCH_ACTION_OVERLAY_WIDTH;
const MILESTONE_SEARCH_ICON_RELEASE_WIDTH = 420 + MILESTONE_SEARCH_ACTION_OVERLAY_WIDTH;
